...
// TODO: 取得 LargePlant 的數值 0
export const catKeyName: PlantCategory = PlantCategory.LargePlant;
...
*/
type UpdateProduct=Pick<Product,"id"|"title"> & Partial<Omit<Product,"id"|"title">>
...
*/
export type TSubmitType="create"| "update"

export const submitProduct=(type:TSubmitType, product:CreateProduct | UpdateProduct)=>{
  switch (type) {
    case "create":
